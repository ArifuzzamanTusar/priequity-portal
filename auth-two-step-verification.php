...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title>Two Step Verification | Priequity - Admin & Dashboard Template</title>
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Priequity   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                    </div>
                                </div>
                            </div>
                        </div>
