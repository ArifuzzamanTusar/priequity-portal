                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td> <?php echo $app['capital_uses']  ?> </td>
                                                <td> <?php echo $app['capital_need']  ?> </td>
                                                <td> <?php $portal->appStatus($app['status']) ?> </td>
                                                <td>

                                                    <a href="view-application.php?app-id=<?php echo $app['id'] ?>" title="Manage" class="btn btn-outline-primary waves-effect waves-light mx-2"><i class="far fa-eye"></i> View </a>
                                                </td>
